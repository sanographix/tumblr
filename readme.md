...
- まず、sanographix作のテーマ **以外** でも同様の現象が発生するか確認してください。
    - デフォルトテーマで確認するのがよいと思います
- 別のテーマでも同様の現象が発生するなら、Tumblr側の仕様の可能性がありますので、Tumblr側のサポートに問い合わせてください。
...
##### Q: スマホのブラウザで見たら違うテーマになってます

* 「▾ 詳細設定」の「モバイルレイアウトを使用する」の **チェックを外してください。**

##### Q: スマホのTumblrアプリから見たら違うテーマになってます
