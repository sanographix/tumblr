...
#### Q: スマホのブラウザやTumblrアプリで見たら違うテーマになっています

* Tumblr側の仕様です。PCから「▾ 詳細設定」の「モバイルレイアウトを使用する」の **チェックを外してください。**

#### Q: スマホのブラウザやTumblrアプリでテーマの設定ができません

* Tumblr側の仕様です。PCから設定してください。
...
#### Q: クレジット表記（大抵はフッターにあります）を消して使ってもよいですか？
