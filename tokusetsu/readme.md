...
| Store URL | CDがwebで購入できる場合は、ストアの商品ページのURLを入力します。（Staff URLと名前が似ているのでフォームの場所がわかりにくいかもしれません） |  |
|Consignment |委託販売する場合は委託先を入力します。| |
|Consignment URL |委託販売する場合は委託先を入力します。| |
...
* 曲が10曲以上あるから入力欄を増やしたい
	* HTMLを直接編集してください。分からなかったらHTMLの分かる知り合いなどに手伝ってもらってください。
